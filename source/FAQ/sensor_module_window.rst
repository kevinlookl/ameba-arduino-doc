...
Contact for Camera Sensor Module Manufacturing
--------------------------------------------------
...
- Camera Sensor Model (e.g., GC2053, IMX327, OV5647)

- Focus Type (Fixed focus or adjustable focus)

- Pin Interface (Pin configuration / hardware interface definition)

- IR Filter (With or without IR-cut filter)

- Field of View (FOV) / Depth

- Focusing Distance

- FPC Length (Flexible Printed Circuit cable length requirement)

Manufacturing Contact Points
--------------------------------

For inquiries, customization, or procurement, please contact:
...
.. Hidden table (will not appear in any output)

   Camera Sensors Available
   ----------------------------
   
   The following table summarizes available camera sensors, manufacturers, and current validation status:
   
   +------------------+------------------+-------------------------------+
   | Camera Sensor    | Manufacturer     | Status                        |
   +==================+==================+===============================+
   | F37              | Realtek          | Tested, available             |
   |                  +------------------+-------------------------------+
